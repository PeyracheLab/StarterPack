...
from wrappers import loadSpikeData, makeEpochs, loadEpoch, loadPosition
...
# To make things easier, we will take only the first wake episode
wake_ep = wake_ep.drop(1)
...
tuning_curves = computeAngularTuningCurves(spikes, position['ry'], wake_ep, nb_bins = 61)
...
decoded, proba_angle = decodeHD(tuning_curves, spikes_hd, wake_ep)
